    ...
    const initAuth = async () => {
        ...
        if (savedUserStr) {
            try {
                ...
                // We use the ID and Role from local storage to hit the correct profile endpoint
                // If 401, axiosClient interceptor will clear localStorage
                try {
                    ...
                    // If verification fails (e.g. token expired), clear user
