...
const Checkout = () => {
  ...
  const handlePlaceOrder = async (e: React.FormEvent) => {
    ...
    // Normalize time to HH:mm (24-hour format) for consistent backend parsing
    const now = new Date();
    ...
    const orderPayload = {
        ...
        items: cart, // Service layer will map this to {id, qty}
        ...
        // status is ignored by backend now for security, but we keep it structure-wise
        status: 'pending'
    };
